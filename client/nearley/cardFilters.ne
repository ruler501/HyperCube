...
cmcCondition -> ("mv"i | "cmc"i | "manavalue"i) integerOpValue {% ([, valuePred]) => genericCondition('cmc', cardCmc, valuePred) %}
...
collectorNumberCondition -> ("cn"i | "number"i) stringOpValue {% ([, valuePred]) => genericCondition('collector_number', cardCollectorNumber, valuePred) %}
...
isValue -> (
  ...
  | "vanilla"i | "modal"i | "fullart"i | "foil"i | "nonfoil"i | "reprint"i | "firstprint"i | "firstprinting"i
